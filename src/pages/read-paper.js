...
export default function ReadPaper() {
 ...
 //Paper 1
 const paperAbstract1 = "Inefficient knock-in of transgene cargos limits the potential of cell-based medicines. In this study, we used a CRISPR nuclease that targets a site within an exon of an essential gene and designed a cargo template so that correct knock-in would retain essential gene function while also integrating the transgene(s) of interest. Cells with non-productive insertions and deletions would undergo negative selection. This technology, called SLEEK (SeLection by Essential-gene Exon Knock-in), achieved knock-in efficiencies of more than 90% in clinically relevant cell types without impacting long-term viability or expansion";
 
 // Paper 2
 const paperAbstract2 = "The first gene therapies for tackling heart failure are making progress in the clinic. Rocket Pharmaceuticals aims shortly to start a pivotal phase 2 study of a gene therapy for patients with Danon disease, an X-linked dominant disorder that causes progressive heart failure and death in early adulthood. If successful, the trial will encourage a slew of developers of genetic medicines to believe that arresting or even reversing progressive heart failure is feasible in different disease settings.";
